            ...
            <div class="span12" style="width:700px; margin: -30px">
                <div id="homeCarousel" class="carousel slide">
                    <div class="carousel-inner" style="height: 413px"> 
                        ...
                        <div class="item">
                            <img src="img/Colegio/3. Foto 1.jpg">
                            <div class="carousel-caption">
                                <p>Instituto Santa Teresita</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/3. Foto.jpg">
                            <div class="carousel-caption">
                                <p>Instituto Santa Teresita</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Biblioteca 1.jpg">
                            <div class="carousel-caption">
                                <p>Biblioteca</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Laboratorio.jpg">
                            <div class="carousel-caption">
                                <p>Laboratorio</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Laboratorio 2.jpg">
                            <div class="carousel-caption">
                                <p>Laboratorio</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Laboratorio 1.jpg">
                            <div class="carousel-caption">
                                <p>Laboratorio</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Pastor.jpg">
                            <div class="carousel-caption">
                                <p>Pastor</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Sala de computacion.jpg">
                            <div class="carousel-caption">
                                <p>Sala de computación</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Sala de videos.jpg">
                            <div class="carousel-caption">
                                <p>Sala de videos</p>
                            </div>
                        </div> 
                        <div class="item">
                            <img src="img/Colegio/Virgen capilla.jpg">
                            <div class="carousel-caption">
                                <p>Virgen de la Capilla</p>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="home-niveles-contenedor-nivel-contenido-masinfo"> 
                        ...
                        <div class="nivel-dos" style="display: none">
                            <div style="float: left; width: 50%"><i>“No poseo el valor para buscar plegarias hermosas en los libros; al no saber cuáles escoger, reacciono como los niños; le digo sencillamente 
                                ...
                                •   Valores - <a href="pdf/NIVEL PRIMARIO - Valores.pdf" class="home-niveles-descargar" target="_blank"><b>Descargar</b></a><br><br>
                                •   Actividades<br><br>                                
                            </div>
                        ...
                        <div class="nivel-tres" style="display: none">
                            <div style="float: left; width: 50%"><i>"Dar lo mejor de nosotros mismos, sin condiciones, sin reproches, sin esperar nada a cambio. Ésa es la clave para alcanzar el éxito." L.M. López
                                ...
                                •   Valores - <a href="pdf/NIVEL SECUNDARIO - Valores.pdf" class="home-niveles-descargar" target="_blank"><b>Descargar</b></a><br><br>
                                •   Actividades<br><br>
                            </div>
                        ...
                        <div class="nivel-cuatro" style="display: none">
                            ...
                            Ef. 4,4</i><br><br>
                                ...
                                •   <a href="http://santateresita.cba.infd.edu.ar/sitio/" class="home-niveles-descargar" target="_blank"><b>Más información</b></a><br><br>
                                •   Actividades<br><br>
                                <br>
                            </div>
                            ...
                            <div class="row nivel-uno" style="margin-top: 105px; display: none">
                                <div class="span12" style="width:500px">
                                    <div id="homeCarouselNivelUno" class="carousel slide">
                                        ...
                                        <a class="carousel-control left" href="#homeCarouselNivelUno" data-slide="prev">&lsaquo;</a>
                                        <a class="carousel-control right" href="#homeCarouselNivelUno" data-slide="next">&rsaquo;</a>
                                    </div>
                                </div>
                            </div>

                            <div class="row nivel-dos" style="margin-top: 105px; display: none">
                                <div class="span12" style="width:500px">
                                    <div id="homeCarouselNivelDos" class="carousel slide">
                                        <div class="carousel-inner"> 
                                            <div class="active item">
                                                <img src="img/Nivel primario/Recorriendo el barrio.jpg">
                                                <div class="carousel-caption">
                                                    <p>Recorriendo el barrio</p>
                                                </div>
                                            </div> 
                                            <div class="item">
                                                <img src= "img/Nivel primario/Promesa de Lealtad a la Bandera.jpg">
                                                <div class="carousel-caption">
                                        ...
                                        <a class="carousel-control left" href="#homeCarouselNivelDos" data-slide="prev">&lsaquo;</a>
                                        <a class="carousel-control right" href="#homeCarouselNivelDos" data-slide="next">&rsaquo;</a>
                                    </div>
                                </div>
                            </div>

                            <div class="row nivel-tres" style="margin-top: 105px; display: none">
                                <div class="span12" style="width:500px">
                                    <div id="homeCarouselNivelTres" class="carousel slide">
                                        <div class="carousel-inner"> 
                                            <div class="active item">
                                        ...
                                        <a class="carousel-control left" href="#homeCarouselNivelTres" data-slide="prev">&lsaquo;</a>
                                        <a class="carousel-control right" href="#homeCarouselNivelTres" data-slide="next">&rsaquo;</a>
                                    </div>
                                </div>
                            </div>

                            <div class="row nivel-cuatro" style="margin-top: 105px; display: none">
                                <div class="span12" style="width:500px">
                                    <div id="homeCarouselNivelCuatro" class="carousel slide">
                                        <div class="carousel-inner"> 
                                            <div class="active item">
                                        ...
                                        <a class="carousel-control left" href="#homeCarouselNivelCuatro" data-slide="prev">&lsaquo;</a>
                                        <a class="carousel-control right" href="#homeCarouselNivelCuatro" data-slide="next">&rsaquo;</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div id="institucion">
        ...
        <div id="historia" class="home-institucion-contenedor" style="height: 1050px">
            ...
            <div class="home-institucion-contenedor-contenido" style="height: 94%"> 
                <div style="float: left">Verano de 1930. Con más expectativas que certezas, un ya lejano 29 de enero, llegaban a Balnearia las primeras religiosas de la Congregación de las Hermanas de
                ...
                <div>
                    ...
                    otorgar títulos de Profesor de Primero y Segundo Ciclo de E.G.B. <br><br>En la actualidad se está dictando el Profesorado de Biología, atendiendo a las demandas que surgen en el momento.
                </div>                
            </div>
        </div>
        ...
        <div id="formacion" class="home-institucion-contenedor" style="height: 950px">
            ...
            <div class="home-institucion-contenedor-contenido"  style="height: 94%"> 
                <div style="float: left">El estilo de formación del Instituto Santa Teresita se caracteriza por “la caridad en el ocultamiento” que ha de animar a todos los miembros de la comunidad educativa 
                    ...
                    bien común.<br><br>Esta animación, tanto en lo educativo como en lo catequístico-pastoral, es promovida por la superiora de la comunidad, la representante legal, los directivos y el 
                    capellán del Colegio. Colaboran directamente los jefes de Departamentos de materias afines, los alumnos delegados de cada curso y los padres representantes de cada curso.<br><br>Derivados 
                    de estos propósitos se asumen y promueven los siguientes VALORES:
                </div>
                ...
                <div  style="display: inline-block;"><br>•   Formación científica y artística<br>•   Amor a la Patria, a sus símbolos y a sus tradiciones<br>•   Fe<br>•   Adhesión a Cristo<br>•   Devoción Eucarística<br>•   Devoción Marina
                    <br>•   Vida Sacramental<br>•   Oración<br>•   Sinceridad<br>•   Autenticidad<br>•   Adhesión al Instituto<br>•   Coherencia<br>•   Admiración
                </div>
            </div>
        </div>
        ...
        <div id="simbolos" class="home-institucion-contenedor" style="height: 1340px">
            ...
            <div class="home-institucion-contenedor-contenido" style="height: 96%"> 
                ...
                <div><br><br><br><br><br><br><b>HIMNO AL COLEGIO</b><br><br>Cantemos el himno de historia gloriosa<br>Colegio Santa Teresita,<br>recinto que entregas en vida armoniosa<br>sueños e ideales de paz y de amor.<br><br>Al 
                    ...
                    escolares y ayuda económica para alumnos carenciados y familias carenciadas<br>•   Ayuda espiritual  a familias necesitadas.<br>•   Sistema tutorial para alumnos  del nivel superior<br>
                </div>
            </div>
        </div>
        ...
        <div id="patronos" class="home-institucion-contenedor" style="height: 835px;">
            ...
            <div class="home-institucion-contenedor-contenido" style="height: 93%"> 
                ...
                <div><br><br><br><br>Agustín Roscelli nació en Bargone di Casarza Ligure (Génova, Italia), el 27 de julio de 1818, en el seno de una humilde familia. 
                    ...
                    vida espiritual con una austera ascesis y una alcansable caridad.
                </div>
                ...
                <div><br><br><br><br><br>Teresita nació en Francia, el 2 
                    ...
                    a quien un día le consagraría su vida entera.
                </div>                
            </div>
        </div>
